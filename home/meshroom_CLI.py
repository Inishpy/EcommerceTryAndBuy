...
def main():
    print("meshroom", dirname)
    print("meshroom_-_" + os.getcwd())#C:\Users\INISH\Desktop\Repo\PS6_Team_Shannon
    #return
    ...
    baseDir = os.getcwd() + "\\static\\shobj"          ##  --> name of the Folder containing the process (a new folder will be created)
    imgDir = os.getcwd() + "\\static\\images\\Frames"            ##  --> Folder containing the images 
